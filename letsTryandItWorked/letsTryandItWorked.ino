...
// ================= OBSTACLE =================
const int SAFE_DISTANCE = 7;
const int SLOW_DISTANCE = 35;

// ================= TURN PARAMETERS =================
const float TARGET_TURN = 75.0;

const int TURN_MIN_SPEED = 170;   // lowered start torque
...
void loop()
{
  ...
  if(currentState == STATE_TURNING_RIGHT)
  {
    ...
    delayMicroseconds(50); // H-bridge settle
